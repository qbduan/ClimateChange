...
sigma_st <- readRDS("sigma_tmax.rds")[1:72,]
...
for(i in 1:ns){Y[,i]<-data.byst_elen_y[[i]]$tmax} #with seasonality
...
filenames <- paste("fittingsqr_allsts_tmax_nosoi",runid,".rds",sep = "")
